...
const MIXING_MODES = {
  ...
  ultimate: {
    ...
    privacy: "⭐⭐⭐⭐⭐⭐⭐",
    time: "1 - 5 min",
    description: "Multi-chain Routing · Enhanced Privacy · Hard to Trace",
    color: "red",
...
function StealthTransferApp({ lang }: { lang: "en" | "zh" }) {
  ...
  const t = {
    en: {
      ...
      ultimatePrivacyDesc: "Multi-chain Routing · Enhanced Privacy · Hard to Trace",
      singleChainMixing: "Single-chain Privacy Transfer",
      ...
      multiHopCrossChain: "Multi-hop cross-chain + multi-chain paths obscure the fund trail and protect your IP, greatly improving privacy",
      ...
      faq: "FAQ",
      faqQuestion1: "How does this improve transfer privacy?",
      ...
      faq1MixLayer: "Privacy Layer: T1 randomly hops through 10-100 HD wallet addresses",
      ...
      faq1Conclusion: "Result: Even with tools like Chainalysis, linking A to Z becomes very difficult",
      faq1Ultimate: "Ultimate Privacy - Cross-chain Break:",
      faq1MixBefore: "Route to a new temp address before each cross-chain",
      faq1Bridge: "Bridge records: Temp B → Temp C (different chains)",
      faq1Unlinkable: "Hard to link: Source A on BSC, Target Z on BSC, but routed via Polygon, Arbitrum",
      ...
      faq2AutoClear: "After the transfer, intermediate addresses auto-cleared, no balance left",
      ...
      faq3FastTech: "Dual-layer isolation + multi-hop routing, 10-100 intermediate addresses random hops",
      faq3PrivacyLevel: "Privacy Level:",
      faq3FastPrivacy: "⭐⭐⭐⭐⭐ Raises the bar against blockchain explorers and common analysis tools",
      ...
      faq3UltimatePrivacy: "⭐⭐⭐⭐⭐⭐⭐ Significantly raises the difficulty for pro tools like Chainalysis, Elliptic",
      ...
      faq4Requires: "Privacy routing requires generating 10-100 intermediate addresses",
      ...
      faq4CannotGen: "Cannot generate multiple intermediate addresses for privacy routing",
      ...
      faq4AutoClear: "After the transfer, intermediate addresses auto-cleared",
      ...
      faq4Discard: "After the transfer, can discard the mnemonic",
      ...
      startMixing: "Starting privacy transfer...",
      mode: "Mode:",
    ...
    zh: {
      ...
      ultimatePrivacyDesc: "多链路由 · 提升隐私安全性 · 难以追溯",
      singleChainMixing: "单链隐私转账",
      vpnRecommended: "建议使用VPN保护IP",
      suitableSmallTransfers: "适合小额转账（<0.5 BNB）",
      suitableLargeTransfers: "适合大额转账",
      multiHopCrossChain: "多跳跨链 + 多链路径，打散资金路径并保护 IP，大幅提升隐私安全性，难以追溯",
      selectNetwork: "选择网络",
      ...
      faq2AutoClear: "隐私转账完成后，中间地址自动清空，无余额残留",
      ...
      faq3FastTech: "双层隔离 + 多跳隐私转账，10-100个中间地址随机跳转",
      faq3PrivacyLevel: "隐私等级：",
      faq3FastPrivacy: "⭐⭐⭐⭐⭐ 可提升对区块链浏览器、常见分析工具的防护",
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      if (mode === 'ultimate') {
        ...
        setProgress(prev => [...prev, `🔒 ${lang === 'en' ? 'Source obscured: amount split + currency changed + chain bridged' : '源地址已隐匿：金额打碎 + 币种切换 + 跨链断点'}`]);
